var LF = {}; (function(A, au) {
    ...
    var ac = (function() {
        ...
        aC.ll_createStage = function() {
            ...
            y.addEventListener(aC.window, "blur",
            function() {
        ...
        aC.show = function(aF) { ! aF && (aF = aC.childList);
            for (var aE = 0,
            aD = aF.length,
            aG; aE < aD; aE++) {
                aG = aF[aE];
    ...
    function J() {
        ...
        if (J.arguments.length > 0 && aE == null) {
            ...
            aC.innerHTML = "Hide";
            aG.appendChild(aC);
            y.addEventListener(aC, ac.mobile ? "touchstart": "click",
            function(aH) {
                ...
                if (typeof aN !== "string") {
                    if (Object.prototype.toString.apply(aN) == "[object AudioBuffer]") {
                        ...
                        if (Object.prototype.toString.apply(aN) == "[object ArrayBuffer]") {
                            ...
                            aO.data.decodeAudioData(aN, aO.onload.bind(aO),
                            function(aP) {
    ...
    var a = (function() {
        function aC(aF) {
            ...
            if (aC.webAudioEnabled && ac.webAudio) {
                ...
                aG.playing = false;
                aG.data.addEventListener("play",
                function() {
                    aG.playing = true
                },
                false);
                aG.data.addEventListener("pause",
                function() {
                    aG.playing = false
                },
                false)
    ...
    var l = (function() {
        ...
        var aE = {
            ...
            remove: function(aG) {
                for (var aF = 0,
                aH = this.setList.length; aF < aH; aF++) {
    ...
    var D = (function() {
        ...
        aF = {
            ...
            pauseAll: function() {
                for (var aI = 0,
                aH = this.tweens.length; aI < aH; aI++) {
    ...
    function j(aF) {
        ...
        var aC = g_rem * aF;
        function aI(aJ) {
            return aJ.replace(/([.\d]+)(px|em|rem|pt)/g,
            function(aL, aK, aM) {
                return (aK * aF) + aM
            })
        }
                ...
                aD[aE] = (function(aG) {
                    return function() {
                        ...
                        if (aF === "all") {
                            ...
                            if (Array.isArray(aF)) {
                                for (aJ = 0, aH = aF.length; aJ < aH; aJ++) {
                                    aI[aF[aJ]] *= aC
                                }
                            }
                        }
