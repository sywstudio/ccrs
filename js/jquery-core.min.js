...
(function(a2, aB) {
    ...
    bG.Callbacks = function(b9) {
        b9 = typeof b9 === "string" ? (bU[b9] || ac(b9)) : bG.extend({},
        b9);
        var b2, e, b3, b0, b4, b5, b6 = [],
        b7 = !b9.once && [],
        b1,
        bZ = function(ca) {
            b2 = b9.memory && ca;
        ...
        b8 = {
            add: function() {
                if (b6) {
                    var cb = b6.length; (function ca(cc) {
                        bG.each(cc,
                        function(ce, cd) {
                            var cf = bG.type(cd);
 ...
 */
    ...
    bG.extend({
        ...
        ajax: function(b4, b1) {
            ...
            if (b8.data && b8.processData && typeof b8.data !== "string") { (function() {
